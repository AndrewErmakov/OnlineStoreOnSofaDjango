...
urlpatterns = [
    ...
    path('products_by_rubric/<int:pk>/', ProductsByRubricView.as_view(), name='products_by_rubric'),
    ...
    path('order_created/<int:encrypted_order_num>/<int:key>/', CreatedOrderView.as_view(), name='order_created'),
